...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim):
        ...
        self.deconv1 = deconv(in_channels=100, out_channels=128, kernel_size=4, stride=2, padding=0)
        ...
        self.deconv4 = deconv(in_channels=32, out_channels=3, kernel_size=4, stride=2, padding=1)
...
class CycleGenerator(nn.Module):
    ...
    def __init__(self, conv_dim=64, init_zero_weights=False):
        ...
        self.deconv1 = deconv(in_channels=64, out_channels=32, kernel_size=4, stride=2, padding=1)
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64):
        ...
        self.conv1 = conv(in_channels = 3, out_channels = 32, kernel_size = 2, stride=2, padding=1)
        self.conv2 = conv(in_channels = 32, out_channels = 64, kernel_size = 2, stride=2, padding=1)
        self.conv3 = conv(in_channels = 64, out_channels = 128, kernel_size = 2, stride=2, padding=1)
        self.conv4 = conv(in_channels = 128, out_channels = 1, kernel_size = 2, stride=2, padding=0)
